...
(function(window){
    ...
    Query.prototype = {
        ...
        check: function( thing ){
            ...
            // If we are matching on object name...
            if (rules.names && rules.names.length > 0 && thing.name !== rules.names[0]) {
                return false;
            }

            // If we are matching on tags...
            if (rules.tags && rules.tags.length > 0) {
                ...
                for (i = 0; i < rules.tags.length; i++) {
                    if (thing.tags.indexOf(rules.tags[i]) === -1) {
                        return false;
                    }
                }
            }
